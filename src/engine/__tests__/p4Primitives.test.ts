...
test("carrier spread_stack swaps its two carrier roles", () => {
  ...
  const events: unknown[] = effects.map((name, i) => ({ type: "apply_effect", id: `mark-${i}`, t: 0, name, players: [["mt", "ot", "h1", "h2"][i]], applyEffect: { ref: "debug_test_debuff", name, duration: 2 } }));
...
test("carrier gaze excludes its own eyes and reverse requires facing both", () => {
  const world = run([
    { type: "apply_effect", id: "mark-mt", t: 0, name: "Shriek", players: ["mt", "ot"], applyEffect: { ref: "debug_test_debuff", name: "Shriek", duration: 2 } },
...
test("normal carrier gaze is a cone from its carrier", () => {
  const world = run([
    { type: "apply_effect", id: "mark", t: 0, name: "Shriek", players: ["mt"], applyEffect: { ref: "debug_test_debuff", name: "Shriek", duration: 2 } },
...
test("effect_burst chooses the hidden donut when inverted", () => {
  const world = run([
    { type: "apply_effect", id: "mark", t: 0, name: "Entropy", players: ["m1"], applyEffect: { ref: "debug_test_debuff", name: "Entropy", duration: 2 } },
...
test("effect groups replace the wound and effect_check kills mismatches", () => {
  const world = run([
    { type: "apply_effect", id: "origin", t: 0, name: "White Wound", players: ["m1"], applyEffect: { ref: "debug_test_debuff", name: "White Wound", duration: 2, group: "origin" } },
    { type: "apply_effect", id: "wound", t: 0, name: "Black Wound", players: ["m1"], applyEffect: { ref: "debug_test_debuff", name: "Black Wound", duration: 2, group: "wound" } },
    { type: "apply_effect", id: "field", t: 0, name: "Allagan Field", players: ["m1"], applyEffect: { ref: "debug_test_debuff", name: "Allagan Field", duration: 2 } },
  ...
  const failed = run([
    { type: "apply_effect", id: "origin", t: 0, name: "White Wound", players: ["m1"], applyEffect: { ref: "debug_test_debuff", name: "White Wound", duration: 2, group: "origin" } },
    { type: "apply_effect", id: "wound", t: 0, name: "White Wound", players: ["m1"], applyEffect: { ref: "debug_test_debuff", name: "White Wound", duration: 2, group: "wound" } },
    { type: "apply_effect", id: "field", t: 0, name: "Allagan Field", players: ["m1"], applyEffect: { ref: "debug_test_debuff", name: "Allagan Field", duration: 2 } },
    { type: "effect_check", id: "check", t: 0.1, name: "Death Surge", checks: [{ carriers: "Allagan Field", compare: ["wound", "origin"], expect: "differs" }], failureDamage: 999, failureDamageType: "true" },
  ]);
