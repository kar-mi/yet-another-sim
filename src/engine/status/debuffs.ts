...
export const DEBUFF_REGISTRY: Record<string, EffectSpec> = {
  growing_dread: {
    ...
    duration: 999,
    showTimer: false,
    icon: "growing_dread.png",
    avoidable: true,
    behavior: { kind: "alternating", alternationKey: "fertile_ground", repeatDamage: 20, repeatDamageType: "magical", repeatApply: "thrice_come_ruin" },
  },
  growing_panic: {
    name: "Growing Panic",
    kind: "debuff",
  ...
  thrice_come_ruin: {
    ...
    stacks: 1,
    showTimer: false,
    icon: "thrice_come_ruin.png",
    avoidable: true,
    behavior: { kind: "escalating", escalationKey: "thrice_come_ruin", escalateTo: "thrice_come_ruin_2" },
  },
  thrice_come_ruin_2: {
    name: "Thrice Come Ruin",
    kind: "debuff",
    ...
    icon: "thrice_come_ruin.png",
    avoidable: true,
    behavior: { kind: "escalating", escalationKey: "thrice_come_ruin", escalateTo: "thrice_come_ruin_3", escalateDamage: 999999, escalateDamageType: "true" },
  },
  thrice_come_ruin_3: {
    name: "Thrice Come Ruin",
    kind: "debuff",
    ...
    icon: "thrice_come_ruin.png",
    avoidable: true,
    behavior: { kind: "escalating", escalationKey: "thrice_come_ruin", escalateDamage: 999999, escalateDamageType: "true" },
  },
  magic_vulnerability: {
