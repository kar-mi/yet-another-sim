...
const GLYPH_STROKES: Record<WaymarkId, Stroke[]> = {
  A: [line([-0.48, -0.58], [0, 0.62], [0.48, -0.58]), line([-0.25, -0.04], [0.25, -0.04])],
  B: [
  ...
  "1": [line([0, -0.6], [0, 0.6]), line([-0.28, 0.35], [0, 0.6], [0.24, 0.6]), line([-0.32, -0.6], [0.32, -0.6])],
  "2": [join(arc(-0.02, 0.32, 0.46, 0.28, 2.55, -0.55, 14), line([0.32, 0.05], [-0.44, -0.6], [0.5, -0.6]))],
  "3": [
  ...
  "4": [line([0.36, -0.6], [0.36, 0.6]), line([-0.48, 0.08], [0.48, 0.08]), line([-0.42, 0.58], [-0.42, 0.08])],
};
