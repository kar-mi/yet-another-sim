...
const GLYPH_STROKES: Record<WaymarkId, Stroke[]> = {
  ...
  "2": [join(arc(-0.02, 0.31, 0.46, 0.29, 2.55, -0.38, 16), arc(0.13, -0.15, 0.38, 0.24, 0.65, -2.15, 10), line([-0.3, -0.45], [-0.46, -0.6], [0.5, -0.6]))],
  "3": [
  ...
  "4": [line([0.36, -0.6], [0.36, 0.6]), line([-0.48, 0.08], [0.48, 0.08]), line([-0.42, 0.58], [0.08, 0.08])],
};
