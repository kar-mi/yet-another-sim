...
const OVERVIEW_SECTIONS: TourSection[] = [
  ...
  { title: "LOADING A RAID", body: "Once in a session, use the RAID selector at the top of the screen to pick a raid. It loads for everyone at time zero; press START when the group is ready. RAID SETUP, right of your HP bar, holds waymarks, bot patterns and RNG pins." },
...
export function buildTourSteps(ctx: TourContext): TourStep[] {
  ...
  const steps: TourStep[] = [
    ...
    },
    {
      ...
      body: ctx.isHost
        ? "Browse or search raids here. The one you pick loads for everyone, ready to START. RAID SETUP, right of your HP bar, holds waymarks, bot patterns and RNG pins."
